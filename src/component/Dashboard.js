        ...
        <Grid item xs={12} md={6}>
          <Box sx={customTileStyle}>
            ...
            <Stack
              ...
              justifyContent="center"
            >
              <TableContainer component={Paper} elevation={2} sx={customTableStyle}>
                <Table size="small" aria-label="table">
                  <TableHead>
                    <TableRow >
                      ...
                      <TableCell sx={{fontWeight: 600}} align="center">Days left</TableCell>
                ...
                <Table size="small" aria-label="table">
                  <TableHead>
                    <TableRow>
                      ...
                      <TableCell sx={{fontWeight: 600}} align="center">Date</TableCell>
                      <TableCell sx={{fontWeight: 600}} align="center">Issue</TableCell>
                  ...
                  <TableBody>
                    {maintenanceRecordList.map((row) => (
                      <TableRow
                        ...
                        sx={{ '&:last-child td, &:last-child th': { border: 0 } }}
                      >
                        <TableCell align="center" component="th" scope="row">{row.no}</TableCell>
